...
internal static unsafe class GraphicsMemoryAllocatorTests
{
    ...
    public static void FreeNonAdjacentRegionsRemainFragmentedTest()
    {
        ...
        // The gaps are distinct (64K and 128K) and must not be treated as one 192K span:
        // an allocation of the combined free length fails, while one fitting the larger gap succeeds.
