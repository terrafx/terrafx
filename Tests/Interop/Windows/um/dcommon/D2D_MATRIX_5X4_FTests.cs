...
namespace TerraFX.Interop.UnitTests
{
    ...
    {
        /// <summary>Validates that the layout of the <see cref="D2D_MATRIX_5X4_F" /> struct is <see cref="LayoutKind.Explicit" />.</summary>
        [Test]
        public static void IsLayoutExplicitTest()
        {
            Assert.That(typeof(D2D_MATRIX_5X4_F).IsExplicitLayout, Is.True);
        }
