...
namespace TerraFX.Interop.DXGI
{
    ...
    public interface IDXGISwapChain4 : IDXGISwapChain3
    {
        ...
        new void ResizeBuffers1([In] uint BufferCount, [In] uint Width, [In] uint Height, [In] DXGI_FORMAT Format, [In] uint SwapChainFlags, [In] ref uint pCreationNodeMask, [MarshalAs(UnmanagedType.IUnknown), In] ref object ppPresentQueue);
