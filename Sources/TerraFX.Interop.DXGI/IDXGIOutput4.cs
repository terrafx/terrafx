...
namespace TerraFX.Interop.DXGI
{
    ...
    public interface IDXGIOutput4 : IDXGIOutput3
    {
        ...
        #region Methods
        void CheckOverlayColorSpaceSupport([In] DXGI_FORMAT Format, [In] DXGI_COLOR_SPACE_TYPE ColorSpace, [MarshalAs(UnmanagedType.IUnknown), In] object pConcernedDevice, out DXGI_OVERLAY_COLOR_SPACE_SUPPORT_FLAG pFlags);
        #endregion
    }
}
