...
namespace TerraFX.Interop
{
    ...
    unsafe public struct Window : IComparable, IComparable<Window>, IEquatable<Window>, IFormattable
    {
        #region Fields
        ...
        public Window(uint value) : this((UIntPtr)(value))
        {
        }

        /// <summary>Initializes a new instance of the <see cref="Window" /> struct.</summary>
        /// <param name="value">The value of the instance.</param>
        public Window(ulong value) : this((UIntPtr)(value))
        {
        }

        /// <summary>Initializes a new instance of the <see cref="Window" /> struct.</summary>
        /// <param name="value">The value of the instance.</param>
        public Window(UIntPtr value)
        {
            _value = value;
        }
        #endregion
        ...
        /// <summary>Compares two <see cref="Window" /> instances to determine relative sort-order.</summary>
        /// <param name="left">The <see cref="Window" /> to compare with <paramref name="right" />.</param>
        /// <param name="right">The <see cref="Window" /> to compare with <paramref name="left" />.</param>
        ...
        /// <summary>Converts a <see cref="Window" /> to an equivalent <see cref="uint" /> value.</summary>
        ...
        /// <summary>Converts a <see cref="Window" /> to an equivalent <see cref="ulong" /> value.</summary>
        /// <param name="value">The <see cref="Window" /> to convert.</param>
        ...
        /// <summary>Converts a <see cref="Window" /> to an equivalent <see cref="UIntPtr" /> value.</summary>
        /// <param name="value">The <see cref="Window" /> to convert.</param>
        public static implicit operator UIntPtr(Window value)
        {
            return value._value;
        }

        /// <summary>Converts a <see cref="ulong" /> to an equivalent <see cref="Window" /> value.</summary>
        ...
        /// <summary>Converts a <see cref="uint" /> to an equivalent <see cref="Window" /> value.</summary>
        ...
        /// <summary>Converts a <see cref="UIntPtr" /> to an equivalent <see cref="Window" /> value.</summary>
        /// <param name="value">The <see cref="UIntPtr" /> to convert.</param>
        public static implicit operator Window(UIntPtr value)
        {
            return new Window(value);
        }
        #endregion
        ...
        #region System.IComparable<Window>
        /// <summary>Compares a <see cref="Window" /> with the current instance to determine relative sort-order.</summary>
