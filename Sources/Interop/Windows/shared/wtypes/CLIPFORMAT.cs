...
namespace TerraFX.Interop
{
    public /* blittable */ struct CLIPFORMAT : IComparable, IComparable<CLIPFORMAT>, IEquatable<CLIPFORMAT>, IFormattable
    {
        ...
        #region Operators
        /// <summary>Explicitly converts a <see cref="CLIPFORMAT" /> value to a <see cref="short" /> value.</summary>
        /// <param name="value">The <see cref="CLIPFORMAT" /> value to convert.</param>
        public static explicit operator short(CLIPFORMAT value)
        {
            return (short)(value._value);
        }

        /// <summary>Explicitly converts a <see cref="short" /> value to a <see cref="CLIPFORMAT" /> value.</summary>
        /// <param name="value">The <see cref="short" /> value to convert.</param>
        public static explicit operator CLIPFORMAT(short value)
        {
            return new CLIPFORMAT((ushort)(value));
        }
        ...
        #region System.IComparable<CLIPFORMAT>
        ...
        #region System.IEquatable<CLIPFORMAT>
