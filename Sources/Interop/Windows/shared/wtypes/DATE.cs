...
{
    public /* blittable */ struct DATE : IComparable, IComparable<DATE>, IEquatable<DATE>, IFormattable
    {
        #region Fields
        ...
        /// <summary>Compares two <see cref="DATE" /> instances to determine relative sort-order.</summary>
        /// <param name="left">The <see cref="DATE" /> to compare with <paramref name="right" />.</param>
        /// <param name="right">The <see cref="DATE" /> to compare with <paramref name="left" />.</param>
        ...
        /// <summary>Implicitly converts a <see cref="DATE" /> value to a <see cref="double" /> value.</summary>
        /// <param name="value">The <see cref="DATE" /> value to convert.</param>
        public static implicit operator double(DATE value)
        {
            return value._value;
        }

        /// <summary>Implicitly converts a <see cref="double" /> value to a <see cref="DATE" /> value.</summary>
        ...
        /// <exception cref="ArgumentException"><paramref name="obj" /> is not <c>null</c> and is not an instance of <see cref="DATE" />.</exception>
        ...
        #region System.IComparable<DATE> Methods
        /// <summary>Compares a <see cref="DATE" /> with the current instance to determine relative sort-order.</summary>
        ...
        #region System.IEquatable<DATE> Methods
