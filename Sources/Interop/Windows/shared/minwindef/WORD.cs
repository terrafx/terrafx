...
namespace TerraFX.Interop
{
    public /* blittable */ struct WORD : IComparable, IComparable<WORD>, IEquatable<WORD>, IFormattable
    {
        ...
        /// <summary>Compares two <see cref="WORD" /> instances to determine equality.</summary>
        /// <param name="left">The <see cref="WORD" /> to compare with <paramref name="right" />.</param>
        /// <param name="right">The <see cref="WORD" /> to compare with <paramref name="left" />.</param>
        ...
        /// <summary>Compares two <see cref="WORD" /> instances to determine inequality.</summary>
        /// <param name="left">The <see cref="WORD" /> to compare with <paramref name="right" />.</param>
        /// <param name="right">The <see cref="WORD" /> to compare with <paramref name="left" />.</param>
        ...
        /// <summary>Compares two <see cref="WORD" /> instances to determine relative sort-order.</summary>
        /// <param name="left">The <see cref="WORD" /> to compare with <paramref name="right" />.</param>
        /// <param name="right">The <see cref="WORD" /> to compare with <paramref name="left" />.</param>
        ...
        #region System.IComparable<WORD> Methods
        ...
        #region System.IEquatable<WORD> Methods
