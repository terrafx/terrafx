...
namespace TerraFX.Interop
{
    public /* blittable */ struct DWORD : IComparable, IComparable<DWORD>, IEquatable<DWORD>, IFormattable
    {
        ...
        /// <summary>Compares two <see cref="DWORD" /> instances to determine equality.</summary>
        /// <param name="left">The <see cref="DWORD" /> to compare with <paramref name="right" />.</param>
        /// <param name="right">The <see cref="DWORD" /> to compare with <paramref name="left" />.</param>
        ...
        /// <summary>Compares two <see cref="DWORD" /> instances to determine inequality.</summary>
        /// <param name="left">The <see cref="DWORD" /> to compare with <paramref name="right" />.</param>
        /// <param name="right">The <see cref="DWORD" /> to compare with <paramref name="left" />.</param>
        ...
        /// <summary>Compares two <see cref="DWORD" /> instances to determine relative sort-order.</summary>
        /// <param name="left">The <see cref="DWORD" /> to compare with <paramref name="right" />.</param>
        /// <param name="right">The <see cref="DWORD" /> to compare with <paramref name="left" />.</param>
        ...
        /// <summary>Implicitly converts a <see cref="DWORD" /> value to a <see cref="uint" /> value.</summary>
        ...
        #region System.IComparable<DWORD> Methods
        ...
        #region System.IEquatable<DWORD> Methods
