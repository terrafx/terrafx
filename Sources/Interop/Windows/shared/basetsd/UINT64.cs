...
namespace TerraFX.Interop
{
    public /* blittable */ struct UINT64 : IComparable, IComparable<UINT64>, IEquatable<UINT64>, IFormattable
    {
        ...
        /// <summary>Compares two <see cref="UINT64" /> instances to determine equality.</summary>
        /// <param name="left">The <see cref="UINT64" /> to compare with <paramref name="right" />.</param>
        /// <param name="right">The <see cref="UINT64" /> to compare with <paramref name="left" />.</param>
        ...
        /// <summary>Compares two <see cref="UINT64" /> instances to determine inequality.</summary>
        /// <param name="left">The <see cref="UINT64" /> to compare with <paramref name="right" />.</param>
        /// <param name="right">The <see cref="UINT64" /> to compare with <paramref name="left" />.</param>
        ...
        /// <summary>Compares two <see cref="UINT64" /> instances to determine relative sort-order.</summary>
        /// <param name="left">The <see cref="UINT64" /> to compare with <paramref name="right" />.</param>
        /// <param name="right">The <see cref="UINT64" /> to compare with <paramref name="left" />.</param>
        ...
        #region System.IComparable<UINT64> Methods
        ...
        #region System.IEquatable<UINT64> Methods
