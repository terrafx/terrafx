...
namespace TerraFX.Interop
{
    public /* blittable */ struct INT8 : IComparable, IComparable<INT8>, IEquatable<INT8>, IFormattable
    {
        ...
        /// <summary>Compares two <see cref="INT8" /> instances to determine equality.</summary>
        /// <param name="left">The <see cref="INT8" /> to compare with <paramref name="right" />.</param>
        /// <param name="right">The <see cref="INT8" /> to compare with <paramref name="left" />.</param>
        /// <returns><c>true</c> if <paramref name="left" /> and <paramref name="right" /> are equal; otherwise, <c>false</c>.</returns>
        public static bool operator ==(INT8 left, INT8 right)
        {
            return (left._value == right._value);
        }

        /// <summary>Compares two <see cref="INT8" /> instances to determine inequality.</summary>
        /// <param name="left">The <see cref="INT8" /> to compare with <paramref name="right" />.</param>
        /// <param name="right">The <see cref="INT8" /> to compare with <paramref name="left" />.</param>
        ...
        /// <summary>Compares two <see cref="INT8" /> instances to determine relative sort-order.</summary>
        /// <param name="left">The <see cref="INT8" /> to compare with <paramref name="right" />.</param>
        /// <param name="right">The <see cref="INT8" /> to compare with <paramref name="left" />.</param>
        ...
        /// <summary>Implicitly converts a <see cref="INT8" /> value to a <see cref="sbyte" /> value.</summary>
        ...
        #region System.IComparable<INT8> Methods
        ...
        #region System.IEquatable<INT8> Methods
