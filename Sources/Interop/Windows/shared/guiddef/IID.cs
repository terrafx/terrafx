...
namespace TerraFX.Interop
{
    public /* blittable */ struct IID : IEquatable<IID>, IFormattable
    {
        ...
        /// <summary>Compares two <see cref="IID" /> instances to determine equality.</summary>
        /// <param name="left">The <see cref="IID" /> to compare with <paramref name="right" />.</param>
        /// <param name="right">The <see cref="IID" /> to compare with <paramref name="left" />.</param>
        /// <returns><c>true</c> if <paramref name="left" /> and <paramref name="right" /> are equal; otherwise, <c>false</c>.</returns>
        public static bool operator ==(IID left, IID right)
        {
            return (left._value == right._value);
        }

        /// <summary>Compares two <see cref="IID" /> instances to determine inequality.</summary>
        /// <param name="left">The <see cref="IID" /> to compare with <paramref name="right" />.</param>
        /// <param name="right">The <see cref="IID" /> to compare with <paramref name="left" />.</param>
        ...
        /// <summary>Implicitly converts a <see cref="IID" /> value to a <see cref="Guid" /> value.</summary>
        ...
        #region System.IEquatable<IID> Methods
