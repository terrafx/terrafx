...
namespace TerraFX.Interop
{
    unsafe public /* blittable */ struct HPALETTE : IEquatable<HPALETTE>, IFormattable
    {
        ...
        /// <summary>Explicitly converts a <see cref="HPALETTE" /> value to a <see cref="IntPtr" />* value.</summary>
        /// <param name="value">The <see cref="HPALETTE" /> value to convert.</param>
        public static explicit operator IntPtr(HPALETTE value)
        {
            return (IntPtr)(value._value);
        }

        /// <summary>Explicitly converts a <see cref="IntPtr" /> value to a <see cref="HPALETTE" />* value.</summary>
        /// <param name="value">The <see cref="IntPtr" /> value to convert.</param>
        public static explicit operator HPALETTE(IntPtr value)
        {
            return new HPALETTE((HANDLE)(value));
        }

        /// <summary>Implicitly converts a <see cref="HPALETTE" /> value to a <see cref="UIntPtr" />* value.</summary>
        /// <param name="value">The <see cref="HPALETTE" /> value to convert.</param>
        public static implicit operator UIntPtr(HPALETTE value)
        {
            return value._value;
        }
        ...
        /// <summary>Implicitly converts a <see cref="UIntPtr" /> value to a <see cref="HPALETTE" /> value.</summary>
        /// <param name="value">The <see cref="UIntPtr" /> value to convert.</param>
        public static implicit operator HPALETTE(UIntPtr value)
        {
        ...
        #region System.IEquatable<HPALETTE>
