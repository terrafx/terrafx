...
{
    unsafe public /* blittable */ struct HBITMAP : IEquatable<HBITMAP>, IFormattable
    {
        #region Fields
        ...
        /// <summary>Implicitly converts a <see cref="HBITMAP" /> value to a <see cref="HANDLE" /> value.</summary>
        /// <param name="value">The <see cref="HBITMAP" /> value to convert.</param>
        ...
        /// <summary>Implicitly converts a <see cref="HANDLE" /> value to a <see cref="HBITMAP" /> value.</summary>
        /// <param name="value">The <see cref="HANDLE" /> value to convert.</param>
        public static implicit operator HBITMAP(HANDLE value)
        {
            return new HBITMAP(value);
        }
        #endregion
