...
namespace TerraFX.Interop
{
    public /* blittable */ struct D2D1_TAG : IComparable, IComparable<D2D1_TAG>, IEquatable<D2D1_TAG>, IFormattable
    {
        ...
        #region Operators
        /// <summary>Explicitly converts a <see cref="D2D1_TAG" /> value to a <see cref="long" /> value.</summary>
        /// <param name="value">The <see cref="D2D1_TAG" /> value to convert.</param>
        public static explicit operator long(D2D1_TAG value)
        {
        ...
        /// <summary>Explicitly converts a <see cref="D2D1_TAG" /> value to a <see cref="long" /> value.</summary>
        /// <param name="value">The <see cref="D2D1_TAG" /> value to convert.</param>
        public static explicit operator D2D1_TAG(long value)
        {
            return new D2D1_TAG((ulong)(value));
        }
        ...
        #region System.IComparable<D2D1_TAG>
        ...
        #region System.IEquatable<D2D1_TAG>
