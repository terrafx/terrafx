...
namespace TerraFX.Interop
{
    public /* blittable */ struct D2D_RECT_L
    {
        ...
        #region Operators
        /// <summary>Explicitly converts a <see cref="D2D_RECT_L" /> value to a <see cref="RECT" /> value.</summary>
        ...
        /// <summary>Implicitly converts a <see cref="RECT" /> value to a <see cref="D2D_RECT_L" /> value.</summary>
        /// <param name="value">The <see cref="RECT" /> value to convert.</param>
        public static implicit operator D2D_RECT_L(RECT value)
        {
            return new D2D_RECT_L(value);
        }
        #endregion
    }
}
