...
namespace TerraFX.Interop
{
    public /* blittable */ struct ULONGLONG : IComparable, IComparable<ULONGLONG>, IEquatable<ULONGLONG>, IFormattable
    {
        ...
        /// <summary>Compares two <see cref="ULONGLONG" /> instances to determine equality.</summary>
        /// <param name="left">The <see cref="ULONGLONG" /> to compare with <paramref name="right" />.</param>
        /// <param name="right">The <see cref="ULONGLONG" /> to compare with <paramref name="left" />.</param>
        /// <returns><c>true</c> if <paramref name="left" /> and <paramref name="right" /> are equal; otherwise, <c>false</c>.</returns>
        public static bool operator ==(ULONGLONG left, ULONGLONG right)
        {
            return (left._value == right._value);
        }

        /// <summary>Compares two <see cref="ULONGLONG" /> instances to determine inequality.</summary>
        /// <param name="left">The <see cref="ULONGLONG" /> to compare with <paramref name="right" />.</param>
        /// <param name="right">The <see cref="ULONGLONG" /> to compare with <paramref name="left" />.</param>
        ...
        /// <summary>Compares two <see cref="ULONGLONG" /> instances to determine relative sort-order.</summary>
        /// <param name="left">The <see cref="ULONGLONG" /> to compare with <paramref name="right" />.</param>
        /// <param name="right">The <see cref="ULONGLONG" /> to compare with <paramref name="left" />.</param>
        ...
        #region System.IComparable<ULONGLONG> Methods
        ...
        #region System.IEquatable<ULONGLONG> Methods
