...
{
    unsafe public /* blittable */ struct LPVERSIONEDSTREAM : IEquatable<LPVERSIONEDSTREAM>, IFormattable
    {
        #region Fields
        internal VERSIONEDSTREAM* _value;
        #endregion

        #region Constructors
        /// <summary>Initializes a new instance of the <see cref="LPVERSIONEDSTREAM" /> struct.</summary>
        /// <param name="value">The <see cref="VERSIONEDSTREAM" />* used to initialize the instance.</param>
        public LPVERSIONEDSTREAM(VERSIONEDSTREAM* value)
        {
            _value = value;
        }
        #endregion
        ...
        /// <param name="value">The <see cref="VERSIONEDSTREAM" />* value to convert.</param>
        public static implicit operator LPVERSIONEDSTREAM(VERSIONEDSTREAM* value)
        {
            return new LPVERSIONEDSTREAM(value);
        }
        #endregion
        ...
        {
            return (obj is LPVERSIONEDSTREAM other)
                && Equals(other);
        }
