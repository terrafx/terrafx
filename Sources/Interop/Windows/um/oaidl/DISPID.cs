...
{
    public /* blittable */ struct DISPID : IComparable, IComparable<DISPID>, IEquatable<DISPID>, IFormattable
    {
        #region Fields
        ...
        /// <summary>Implicitly converts a <see cref="int" /> value to a <see cref="DISPID" /> value.</summary>
        ...
        /// <summary>Implicitly converts a <see cref="LONG" /> value to a <see cref="DISPID" /> value.</summary>
        /// <param name="value">The <see cref="LONG" /> value to convert.</param>
        public static implicit operator DISPID(LONG value)
        {
            return new DISPID(value);
        }
        #endregion
        ...
        #region System.IComparable<DISPID> Methods
        ...
        #region System.IEquatable<DISPID> Methods
