...
{
    /// <summary>A HREF type.</summary>
    public struct HREFTYPE : IComparable, IComparable<HREFTYPE>, IEquatable<HREFTYPE>
    {
        #region Fields
        private uint _value;
        #endregion
        ...
        #region Operators
        /// <summary>Compares two <see cref="HREFTYPE" /> instances to determine equality.</summary>
        /// <param name="left">The <see cref="HREFTYPE" /> to compare with <paramref name="right" />.</param>
        /// <param name="right">The <see cref="HREFTYPE" /> to compare with <paramref name="left" />.</param>
        /// <returns><c>true</c> if <paramref name="left" /> and <paramref name="right" /> are equal; otherwise, <c>false</c>.</returns>
        public static bool operator ==(HREFTYPE left, HREFTYPE right)
        {
            return (left._value == right._value);
        }

        /// <summary>Compares two <see cref="HREFTYPE" /> instances to determine inequality.</summary>
        /// <param name="left">The <see cref="HREFTYPE" /> to compare with <paramref name="right" />.</param>
        /// <param name="right">The <see cref="HREFTYPE" /> to compare with <paramref name="left" />.</param>
        ...
        /// <summary>Compares two <see cref="HREFTYPE" /> instances to determine relative sort-order.</summary>
        /// <param name="left">The <see cref="HREFTYPE" /> to compare with <paramref name="right" />.</param>
        /// <param name="right">The <see cref="HREFTYPE" /> to compare with <paramref name="left" />.</param>
        ...
        /// <summary>Converts a <see cref="HREFTYPE" /> to an equivalent <see cref="int" /> value.</summary>
        /// <param name="value">The <see cref="HREFTYPE" /> to convert.</param>
        public static implicit operator uint(HREFTYPE value)
        {
            return value._value;
        }

        /// <summary>Converts a <see cref="int" /> to an equivalent <see cref="HREFTYPE" /> value.</summary>
