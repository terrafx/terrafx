...
namespace TerraFX.Interop
{
    ...
    unsafe public struct HICON : IEquatable<HICON>
    {
        ...
        /// <summary>Converts a <see cref="HICON" /> to an equivalent <see cref="IntPtr" /> value.</summary>
        /// <param name="value">The <see cref="HICON" /> to convert.</param>
        ...
        /// <summary>Converts a <see cref="IntPtr" /> to an equivalent <see cref="HICON" /> value.</summary>
        /// <param name="value">The <see cref="IntPtr" /> to convert.</param>
        public static implicit operator HICON(IntPtr value)
        {
