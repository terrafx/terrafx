...
namespace TerraFX.Interop
{
    ...
    unsafe public struct HMONITOR : IEquatable<HMONITOR>
    {
        ...
        public HMONITOR(UIntPtr value) : this(value.ToPointer())
        {
        }
        ...
        /// <summary>Converts a <see cref="HMONITOR" /> to an equivalent <see cref="UIntPtr" /> value.</summary>
        ...
        /// <summary>Converts a <see cref="UIntPtr" /> to an equivalent <see cref="HMONITOR" /> value.</summary>
