...
namespace TerraFX.Interop
{
    ...
    unsafe public struct HANDLE : IEquatable<HANDLE>
    {
        ...
        public HANDLE(UIntPtr value) : this(value.ToPointer())
        {
        }
        ...
        /// <summary>Converts a <see cref="HANDLE" /> to an equivalent <see cref="UIntPtr" /> value.</summary>
        ...
        /// <summary>Converts a <see cref="UIntPtr" /> to an equivalent <see cref="HANDLE" /> value.</summary>
