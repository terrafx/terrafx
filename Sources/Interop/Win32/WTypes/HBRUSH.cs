...
namespace TerraFX.Interop
{
    ...
    unsafe public struct HBRUSH : IEquatable<HBRUSH>
    {
        ...
        public HBRUSH(UIntPtr value) : this(value.ToPointer())
        {
        }
        ...
        /// <summary>Converts a <see cref="HBRUSH" /> to an equivalent <see cref="UIntPtr" /> value.</summary>
        ...
        /// <summary>Converts a <see cref="UIntPtr" /> to an equivalent <see cref="HBRUSH" /> value.</summary>
