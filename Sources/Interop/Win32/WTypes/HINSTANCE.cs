...
namespace TerraFX.Interop
{
    ...
    unsafe public struct HINSTANCE : IEquatable<HINSTANCE>
    {
        ...
        /// <summary>Converts a <see cref="HINSTANCE" /> to an equivalent <see cref="IntPtr" /> value.</summary>
        /// <param name="value">The <see cref="HINSTANCE" /> to convert.</param>
        ...
        /// <summary>Converts a <see cref="IntPtr" /> to an equivalent <see cref="HINSTANCE" /> value.</summary>
