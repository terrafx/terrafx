...
if [[ ! -z "$architecture" ]]; then
  ...
  . "$DotNetInstallScript" --channel release/5.0.1xx-preview1 --version latest --install-dir "$DotNetInstallDirectory" --architecture "$architecture"
