...
namespace TerraFX.Interop
{
    ...
    public /* unmanaged */ unsafe struct IDWriteFontFile
    {
        #region Fields
        ...
        /// <param name="fontFaceType">The type of the font face that can be conpublic /* unmanaged */ structed from the font file. Note that even if isSupportedFontType is FALSE, the fontFaceType value may be different from DWRITE_FONT_FACE_TYPE_UNKNOWN.</param>
