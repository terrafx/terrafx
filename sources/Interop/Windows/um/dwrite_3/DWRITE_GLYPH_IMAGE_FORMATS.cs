...
{
    /// <summary>Fonts may contain multiple drawable data formats for glyphs. These flags specify which formats are supported in the font, either at a font-wide level or per glyph, and the app may use them to tell DWrite which formats to return when splitting a color glyph run.</summary>
    [Flags]
    public enum DWRITE_GLYPH_IMAGE_FORMATS
    {
        ...
        /// <summary>The glyph has SVG outlines as standard XML.</summary>
        /// <remarks> Fonts may store the content gzip'd rather than plain text, indicated by the first two bytes as gzip header {0x1F 0x8B}.</remarks>
