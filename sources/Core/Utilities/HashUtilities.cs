...
// This file includes code based on the HashHelpers class from https://github.com/dotnet/runtime/
...
internal static class HashUtilities
{
    ...
    public const int MaxPrimeArrayLength = 0x7FFF_FFC3;
    ...
    // hash table operations such as add.  Having a prime guarantees that double
    // hashing does not lead to infinite loops. i.e., your hash function will be
    ...
    public static int GetPrime(int min)
    {
        ...
        {
            var prime = primes.GetReferenceUnsafe(i);
    ...
    // Returns size of hash table to grow to.
