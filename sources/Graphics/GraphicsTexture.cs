...
namespace TerraFX.Graphics
{
    ...
    public abstract unsafe class GraphicsTexture : GraphicsResource
    {
        ...
        protected GraphicsTexture(GraphicsTextureKind kind, in GraphicsMemoryRegion<GraphicsMemoryBlock> blockRegion, GraphicsResourceCpuAccess cpuAccess, uint width, uint height, ushort depth)
