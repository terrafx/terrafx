...
{
    /// <inheritdoc />
    public abstract unsafe class GraphicsTexture<TMetadata> : IGraphicsTexture
...
#pragma warning restore CS0649, IDE0044
        ...
        /// <summary>Initializes a new instance of the <see cref="GraphicsTexture{TMetadata}" /> class.</summary>
        ...
        protected GraphicsTexture(GraphicsTextureKind kind, GraphicsResourceCpuAccess cpuAccess, in GraphicsMemoryRegion<IGraphicsMemoryBlock> memoryBlockRegion, uint width, uint height, ushort depth)
        {
