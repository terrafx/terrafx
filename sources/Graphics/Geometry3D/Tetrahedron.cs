...
namespace TerraFX.Graphics.Geometry3D
{
    ...
    public readonly struct Tetrahedron : IEquatable<Tetrahedron>, IFormattable, IEqualEstimate<Tetrahedron>
    {
        ...
        /// <summary>Tests if two <see cref="Tetrahedron" /> instances (this and right) have sufficiently similar values to see them as equivalent.
        /// Use this to compare values that might be affected by differences in rounding the least significant bits.</summary>
        /// <param name="right">The right instance to compare.</param>
        /// <param name="epsilon">The threshold below which they are sufficiently similar.</param>
        /// <returns>True if similar, false otherwise.</returns>
        public bool EqualEstimate(Tetrahedron right, Tetrahedron epsilon) => _size.EqualEstimate(right._size, epsilon._size);
