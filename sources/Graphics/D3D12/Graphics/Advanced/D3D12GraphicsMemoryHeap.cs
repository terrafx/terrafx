...
public sealed unsafe class D3D12GraphicsMemoryHeap : GraphicsDeviceObject
{
    ...
    internal D3D12GraphicsMemoryHeap(D3D12GraphicsMemoryManager memoryManager, in D3D12GraphicsMemoryHeapCreateOptions createOptions) : base(memoryManager.Device)
    {
        ...
        ID3D12Heap* CreateD3D12Heap(in D3D12GraphicsMemoryHeapCreateOptions createOptions, out uint d3d12HeapVersion)
        {
    ...
    public ID3D12Heap* D3D12Heap => _d3d12Heap;
